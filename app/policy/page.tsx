    ...
    <MainLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mt-6">
          ...
          <p>
            We do not sell, rent, or lease your data. However, we may share it
        ...
        <section className="mt-6">
          ...
          <p>
            We are not responsible for third-party privacy policies and
            encourage users to review them when visiting external sites.
          </p>
        </section>
        ...
        <section className="mt-6">
          ...
          <p>
            ...
            knowingly collect their data and will delete such data if found.
          </p>
        </section>
        ...
        <section className="mt-6">
          ...
          <p>
            We may update this policy, and continued use of our platform
