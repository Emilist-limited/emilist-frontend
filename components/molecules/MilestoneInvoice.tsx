...
import MilestoneInvoiceModal from "../organisms/modal/MilestoneInvoiceModal";
  ...
  return (
    <>
      <div className=" bg-white w-full rounded-lg py-10 px-5">
        <h5 className="sm:text-lg font-semibold mb-2">Invoice</h5>
            ...
            return (
              <div key={index}>
                {milestone?.invoice?.invoiceRaised && (
                  <button
                    className={`w-full flex-c-b rounded-lg h-12 px-4 text-[#FCFEFD] text-sm font-medium ${bgColor}`}
