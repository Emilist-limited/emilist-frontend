...
const RegistrationGuide = () => {
  return (
    <div className=" lg:h-screen lg:max-h-screen h-fit max-sm:h-screen min-h-screen bg-[#054753] text-white w-[500px] max-lg:w-full lg:fixed flex sm:items-center ">
      <div className=" pr-8 py-10 max-sm:pt-20">
